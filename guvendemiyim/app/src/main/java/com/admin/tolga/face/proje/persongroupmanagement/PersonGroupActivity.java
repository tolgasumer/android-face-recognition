...
public class PersonGroupActivity extends AppCompatActivity {
    ...
    class AddPersonGroupTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                faceServiceClient.createPersonGroup(
                        params[0],
                        getString(com.admin.tolga.face.proje.R.string.user_provided_person_group_name),
                        getString(com.admin.tolga.face.proje.R.string.user_provided_person_group_description_data));
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                GridView gridView = (GridView) findViewById(com.admin.tolga.face.proje.R.id.gridView_persons);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.admin.tolga.face.proje.R.layout.activity_person_group);
        ...
        EditText editTextPersonGroupName = (EditText)findViewById(com.admin.tolga.face.proje.R.id.edit_person_group_name);
    ...
    private void initializeGridView() {
        ...
        gridView.setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                Button addNewItem = (Button)findViewById(com.admin.tolga.face.proje.R.id.add_person);
    ...
    private class PersonGridViewAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = layoutInflater.inflate(com.admin.tolga.face.proje.R.layout.item_person, parent, false);
            }
            ...
            if (!faceIdSet.isEmpty()) {
                ...
                ((ImageView)convertView.findViewById(com.admin.tolga.face.proje.R.id.image_person)).setImageURI(uri);
            } else {
                Drawable drawable = getResources().getDrawable(com.admin.tolga.face.proje.R.drawable.select_image);
                ((ImageView)convertView.findViewById(com.admin.tolga.face.proje.R.id.image_person)).setImageDrawable(drawable);
            }

            // set the text of the item
            String personName = StorageHelper.getPersonName(personId, personGroupId, PersonGroupActivity.this);
            ((TextView)convertView.findViewById(com.admin.tolga.face.proje.R.id.text_person)).setText(personName);

            // set the checked status of the item
            CheckBox checkBox = (CheckBox) convertView.findViewById(com.admin.tolga.face.proje.R.id.checkbox_person);
            if (longPressed) {
